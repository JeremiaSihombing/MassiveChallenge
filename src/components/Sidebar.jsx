        ...
        <div className="space-y-3">
          ...
          <div className="flex-1">
            <ul className="pt-2 pb-4 space-y-1 text-sm">
              ...
              <li className="rounded-sm">
                <a href="/manage_account" className="flex items-center p-2 space-x-3 rounded-md">
